...
ANSI_ATTRIBUTES /*static*/ char *fg_rgb(unsigned char r, unsigned char g, unsigned char b) {
...
ANSI_ATTRIBUTES /*static*/ char *bg_rgb(unsigned char r, unsigned char g, unsigned char b) {
  const unsigned char len = 20;
  char *out = (char*)malloc(len);
...
ANSI_ATTRIBUTES /*static*/ char *fg_hex(unsigned int color) { return fg_rgb(HEX_TO_RGB(color)); }
ANSI_ATTRIBUTES /*static*/ char *bg_hex(unsigned int color) { return bg_rgb(HEX_TO_RGB(color)); }
...
ANSI_ATTRIBUTES /*static*/ char *fg_256(unsigned char color) {
  const unsigned char len = 20;
  char *out = (char*)malloc(len);
...
ANSI_ATTRIBUTES /*static*/ char *bg_256(unsigned char color) {
  const unsigned char len = 20;
  char *out = (char*)malloc(len);
  snprintf(out, len, CSI "38;5;%dm", color);
  return out;
